...
import { updateServices } from "../features/markerForm/markerFormSlice";
    ...
    return (
        <div className="facilities-container">
            <Stack direction="row" flexWrap="wrap" justifyContent="center" spacing={1} >
                ...
                <Button variant={bathrooms ? "contained" : "outlined"} onClick={() => {
                    setBathrooms(!bathrooms)
                    updateServices();
                }} endIcon={bathrooms ? <CheckIcon /> : null}>
                    <WcIcon />
                </Button>
                <Button variant={food ? "contained" : "outlined"} onClick={() => {
                    setFood(!food)
                    updateServices();
            ...
            <Stack marginTop="10px" direction="row" flexWrap="wrap" justifyContent="center" spacing={2} >
                <Button variant={wheelchairAccess ? "contained" : "outlined"} onClick={() => {
